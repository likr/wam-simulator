    ...
    <div className='panel-block'>
      <div className='control'>
        ...
        <div className='field is-grouped'>
          ...
          <div className='control is-expanded is-hidden-touch'>
            <button className='button is-small is-fullwidth' onClick={() => { exportImage('png', chart1Ref, 'hour-mf') }}>export PNG</button>
          </div>
        </div>
      </div>
    </div>
    <div className='panel-block'>
      <div className='control'>
        ...
        <div className='field is-grouped'>
          ...
          <div className='control is-expanded is-hidden-touch'>
            <button className='button is-small is-fullwidth' onClick={() => { exportImage('png', chart2Ref, 'dose-mf') }}>Save as PNG</button>
          </div>
        </div>
      </div>
    </div>
