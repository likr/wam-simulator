        ...
        <div className='panel-block'>
          <div className='control'>
            <div className='field'>
              ...
              <p className='help'>
                Maximum value of horizontal axis (time (hour))
              </p>
            </div>
            <div className='field'>
              <label className='label'>
              ...
              <p className='help'>
                Maximum value of horizontal axis (accumulated dose (Gy))
              </p>
            </div>
            <div className='field'>
              <label className='label'>
            ...
            <div className='field'>
              ...
              <p className='help'>
                Maximum value of vertical axis (mutation frequency)
              </p>
            </div>
            <div className='field'>
              <label className='label'>
              ...
              <p className='help'>
                Maximum value of vertical axis (dose rate (Gy/hour))
              </p>
            </div>
          </div>
        </div>
